...
export const itemTranslations = pgTable(
  ...
  (t) => [primaryKey({ columns: [t.itemId, t.languageCode] })],
);
...
export const pictureTranslations = pgTable(
  'bb_picture_translation',
  {
  ...
  (t) => [
    primaryKey({
      columns: [t.pictureId, t.languageCode],
    }),
  ],
);
...
export const pictureRelations = relations(pictures, ({ many }) => ({
  translations: many(pictureTranslations),
}));

export const pictureTranslationRelations = relations(
  pictureTranslations,
  ({ one }) => ({
    picture: one(pictures, {
      fields: [pictureTranslations.pictureId],
      references: [pictures.id],
    }),
  }),
);
...
export type PictureTranslation = typeof pictureTranslations.$inferSelect;